...
def main():
    ...
    st.markdown('This app predicts the **Medical Insurance Cost** based on the input parameters')

    # Get the following input parameters from the user
    # Age, Gender, BMI, Children, Smoker, Region
    age = st.number_input("What is your Age", min_value=0, max_value=100, step=1)
    gender = st.radio("What is your Gender",('Male', 'Female'))
    bmi = st.number_input("What is your BMI", min_value=0.0, max_value=100.0, step=0.1)
    children = st.number_input("How many Children do you have", min_value=0, max_value=10, step=1)
    smoker = st.radio("Do you Smoke",('No', 'Yes'))
    region = st.radio("What is your Region",('Southwest', 'Southeast', 'Northwest', 'Northeast'))
